    ...
    <div className="min-h-screen bg-mythic-void text-foreground overflow-x-hidden font-code selection:bg-primary/30 relative">
      ...
      <header className="relative z-20 border-b border-primary/20 bg-black/60 backdrop-blur-md">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-display text-2xl text-primary tracking-[0.15em]">PANTHEON<span className="text-white">EXUS</span></h1>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/admin">
              <button className="text-[10px] font-display uppercase tracking-widest text-primary border border-primary/30 px-3 py-1.5 hover:bg-primary/10 transition-colors rounded-sm">
                Admin
              </button>
            </Link>
          </div>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h2 className="font-display text-5xl md:text-7xl text-primary tracking-[0.1em] mb-4 drop-shadow-[0_0_30px_rgba(212,175,55,0.4)]">
            The Age of Scions
          </h2>
          ...
          <div className="w-full max-w-6xl mx-auto px-8">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <span className="text-[10px] font-code text-primary/60 uppercase tracking-[0.3em]">Scion Spotlight</span>
              <div className="h-px flex-1 bg-gradient-to-l from-transparent to-primary/30" />
            </div>
            
            {isLoading ? (
              <div className="h-64 flex items-center justify-center">
                <p className="font-code text-sm text-muted-foreground uppercase tracking-widest animate-pulse">Loading Scions...</p>
              </div>
            ) : characters.length > 0 ? (
                  ...
                  <Link key={char.id} href={`/character-sheet/${char.id}`}>
                    <div className="group relative h-[340px] bg-black/80 border border-primary/20 transition-all duration-500 rounded-sm overflow-hidden cursor-pointer hover:shadow-[0_0_40px_rgba(212,175,55,0.3)] hover:-translate-y-2 hover:border-primary" data-testid={`card-scion-${char.id}`}>
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 flex flex-col items-center text-center z-10">
                        ...
                        <h3 className="font-display text-xl text-white group-hover:text-primary transition-colors tracking-widest uppercase mb-1">{char.name}</h3>
                        <p className="text-[10px] font-code text-primary/70 uppercase tracking-[0.2em] mb-3">{char.pantheon || "Unknown"} Pantheon</p>
              ...
              <div className="py-16 flex flex-col items-center justify-center border border-dashed border-primary/20 rounded-sm bg-black/30 backdrop-blur-sm">
                <p className="font-code text-sm text-muted-foreground uppercase tracking-widest mb-4">No Active Scions Found</p>
                <Link href="/admin">
                  <button className="text-xs text-primary hover:text-white border border-primary/30 hover:border-primary px-6 py-3 rounded-sm font-display uppercase tracking-wider flex items-center gap-2 transition-all hover:shadow-[0_0_15px_rgba(212,175,55,0.3)] hover:bg-primary/10" data-testid="button-go-admin">
      ...
      <section className="relative z-20 py-24 bg-gradient-to-b from-mythic-void to-black/90">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl text-primary tracking-[0.2em] mb-2">The World State</h2>
            ...
            {WORLD_STATE_CARDS.map((card) => (
              <div key={card.id} className="group relative overflow-hidden rounded-sm border border-primary/10 bg-black/40 hover:border-primary/40 transition-all duration-500 hover:shadow-[0_0_30px_rgba(212,175,55,0.1)]">
                ...
                <div className="relative p-6">
                  ...
                  <h3 className="font-display text-xl text-primary tracking-widest mb-3">{card.title}</h3>
      ...
      <section className="relative z-20 py-24 bg-black/80">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl text-primary tracking-[0.2em] mb-2">Divine Architecture</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-black/60 border border-primary/20 rounded-sm p-6">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-display text-lg text-primary tracking-widest">Epic Attributes</h3>
              </div>
              ...
              <div className="space-y-3">
                {EPIC_ATTRIBUTES[epicTab].map((attr) => (
                  <div key={attr.name} className="flex justify-between items-center p-3 bg-black/40 border border-primary/10 rounded-sm">
                    <span className="font-display text-primary tracking-widest">{attr.name}</span>
            ...
            <div className="bg-black/60 border border-primary/20 rounded-sm p-6">
              <div className="flex items-center gap-2 mb-6">
                ...
                <h3 className="font-display text-lg text-primary tracking-widest">Divine Purviews</h3>
              </div>
              ...
              >
                ...
                <span className="text-xs uppercase tracking-widest font-code">Open Boons Catalog</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h2 className="font-display text-3xl text-primary tracking-[0.2em]">The Arsenal</h2>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-black/60 border border-primary/20 rounded-sm p-6">
              <h3 className="font-display text-lg text-primary tracking-widest mb-4">Ballistics & Blades Database</h3>
            ...
            {/* Loadouts */}
            <div className="bg-black/60 border border-primary/20 rounded-sm p-6">
              <h3 className="font-display text-lg text-primary tracking-widest mb-4">Standard Issue Loadouts</h3>
              <div className="space-y-4">
                {LOADOUTS.map((kit, i) => (
                  <div key={i} className="p-4 bg-black/40 border border-primary/10 rounded-sm">
                    <h4 className="font-display text-sm text-primary tracking-widest mb-2">{kit.name}</h4>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h2 className="font-display text-3xl text-primary tracking-[0.2em]">FAROUTES Wayfinder</h2>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-black/60 border border-primary/20 rounded-sm p-6 max-h-[500px] overflow-y-auto">
              <h3 className="font-display text-lg text-primary tracking-widest mb-4 sticky top-0 bg-black/90 py-2">
            ...
            <div className="bg-black/60 border border-primary/20 rounded-sm p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="font-display text-lg text-primary tracking-widest">Target Lock</h3>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-black/40 border border-primary/10 rounded-sm">
                  ...
                  <p className="font-display text-primary tracking-widest">{selectedLocation}</p>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h2 className="font-display text-3xl text-primary tracking-[0.2em]">Alleybrary Archives</h2>
            </div>
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-black/60 border border-primary/10 rounded-sm overflow-hidden hover:border-primary/30 transition-all group">
                ...
                <div className="p-4">
                  ...
                  <h4 className="font-display text-primary tracking-widest mb-2">Arquivo {i}</h4>
          ...
          <div className="text-center mt-12">
            <Link href="/alleybrary">
              <button className="text-sm text-primary hover:text-white border border-primary/30 hover:border-primary px-8 py-3 rounded-sm font-display uppercase tracking-wider transition-all hover:shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:bg-primary/10">
